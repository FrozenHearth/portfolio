    ...
    >
      ...
      >
        <Link
          ...
          lg:font-bold text-sky-400 hover:cursor-pointer text-xl lg:text-3xl hover:opacity-90 transition-opacity"
        ...
        <div className="flex items-center md:gap-8 pr-0 mb-2 mt-2 md:mt-0 ml-auto">
          ...
          <a
            ...
            className="p-1 ml-2 mr-1 sm:ml-4 hover:opacity-80 transition-opacity"
